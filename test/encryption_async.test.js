...
describe('encryption async', function() {
    it('convience wrapper with specified iterations', function() {
        ...
        return q.when()
            .then(function() {
                return justencrypt.EncryptionAsync.encrypt(plainText, password, 1)
                    .then(function (cipherText) {
                        return justencrypt.EncryptionAsync.decrypt(cipherText, password)
    ...
    it('convience wrapper with default iterations', function() {
        ...
        return q.when()
            .then(function() {
                return justencrypt.EncryptionAsync.encrypt(plainText, password)
                    .then(function (cipherText) {
                        return justencrypt.EncryptionAsync.decrypt(cipherText, password)
                            .then(function (_plainText) {
                                assert.equal(_plainText.toString('hex'), plainText.toString('hex'));
    ...
    it('encrypt throws errors through promise', function() {
        return q.when()
            .then(function() {
                return justencrypt.EncryptionAsync.encrypt()
                    .then(function() {
    ...
    it('decrypt throws errors through promise', function() {
        return q.when()
            .then(function() {
                return justencrypt.EncryptionAsync.decrypt()
                    .then(function() {
                        assert.fail("should throw error");
                    }, function(err) {
        ...
        it('vector ' + key + ' demonstrates properties of GCM', function() {
            ...
            return q.when()
                .then(function() {
                    ...
                    return justencrypt.EncryptionAsync.encryptWithSaltAndIV(pt, pw, salt, iv, iterations)
                ...
                .then(function() {
                    ...
                    return justencrypt.EncryptionAsync.decrypt(firstEncrypt, pw)
